        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#discoveries" className="text-gray-300 hover:text-white transition-colors">Discoveries</a></li>
              <li><a href="#experiments" className="text-gray-300 hover:text-white transition-colors">Experiments</a></li>
